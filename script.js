...
btnEl.addEventListener("click", (e) => {
  ...
  // Should scan or check empty value...
  if (inputEl.value !== "") {
...
async function findLocation(name) {
  ...
  try {
    ...
    if (result.cod !== "404") {
      ...
      // Should display image content...
      const ImageContent = displayImageContent(result);

      // Should display right side content...
      const rightSide = rightSideContent(result);

      // Should forecast function...
...
// Must display image content and location temperature "in Degrees Celsius" non of that Fahreinheit nonsense...
...
// Should display the right side content...
...
/* Alright it should be working by now...It better be */
/* Bloody Hell yeah!...thats what i am talkig about...I can smell the six figure job getting closer every second.. */